...
func InitConfig() {
	...
	viper.BindEnv("authentication.access-key", "SLOTOPOL_ACCESS_KEY")
	viper.BindEnv("authentication.refresh-key", "SLOTOPOL_REFRESH_KEY")
	viper.BindEnv("activation.brevo-api-key", "SLOTOPOL_BREVO_API_KEY")
	viper.AutomaticEnv()
