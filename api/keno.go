...
func ApiKenoBetGet(c *gin.Context) {
	...
	if err = scene.EnsureOpen(); err != nil {
		Ret403(c, AEC_keno_betget_noaccess, err)
		return
	}
...
func ApiKenoBetSet(c *gin.Context) {
	...
	defer scene.Unlock()
	if err = scene.EnsureOpen(); err != nil {
		Ret403(c, AEC_keno_betset_noaccess, err)
		return
	}
	var game keno.KenoGame
	if game, ok = scene.Game.(keno.KenoGame); !ok {
...
func ApiKenoSelGet(c *gin.Context) {
	...
	defer scene.Unlock()
	if err = scene.EnsureOpen(); err != nil {
		Ret403(c, AEC_keno_selget_noaccess, err)
		return
	}
	var game keno.KenoGame
	if game, ok = scene.Game.(keno.KenoGame); !ok {
...
func ApiKenoSelSet(c *gin.Context) {
	...
	defer scene.Unlock()
	if err = scene.EnsureOpen(); err != nil {
		Ret403(c, AEC_keno_selset_noaccess, err)
		return
	}
	var game keno.KenoGame
	if game, ok = scene.Game.(keno.KenoGame); !ok {
...
func ApiKenoSelGetSlice(c *gin.Context) {
	...
	defer scene.Unlock()
	if err = scene.EnsureOpen(); err != nil {
		Ret403(c, AEC_keno_selgetslice_noaccess, err)
		return
	}
	var game keno.KenoGame
	if game, ok = scene.Game.(keno.KenoGame); !ok {
...
func ApiKenoSelSetSlice(c *gin.Context) {
	...
	defer scene.Unlock()
	if err = scene.EnsureOpen(); err != nil {
		Ret403(c, AEC_keno_selsetslice_noaccess, err)
		return
	}
	var game keno.KenoGame
	if game, ok = scene.Game.(keno.KenoGame); !ok {
...
func ApiKenoSpin(c *gin.Context) {
	...
	defer scene.Unlock()
	if err = scene.EnsureOpen(); err != nil {
		Ret403(c, AEC_keno_spin_noaccess, err)
		return
	}
	var game keno.KenoGame
	if game, ok = scene.Game.(keno.KenoGame); !ok {
